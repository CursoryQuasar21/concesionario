...
class ClienteResourceIT {
    ...
    public static Cliente createEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(DEFAULT_NOMBRE).apellidos(DEFAULT_APELLIDOS).dni(DEFAULT_DNI);
        return cliente;
    }
    ...
    public static Cliente createUpdatedEntity(EntityManager em) {
        Cliente cliente = new Cliente().nombre(UPDATED_NOMBRE).apellidos(UPDATED_APELLIDOS).dni(UPDATED_DNI);
        return cliente;
    }
    ...
    void putNewCliente() throws Exception {
        ...
        updatedCliente.nombre(UPDATED_NOMBRE).apellidos(UPDATED_APELLIDOS).dni(UPDATED_DNI);
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.apellidos(UPDATED_APELLIDOS).dni(UPDATED_DNI);
    ...
    void fullUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.nombre(UPDATED_NOMBRE).apellidos(UPDATED_APELLIDOS).dni(UPDATED_DNI);
